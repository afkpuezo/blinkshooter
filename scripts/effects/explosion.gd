...
var white = preload("res://assets/effects/explosion.png")
var green = preload("res://assets/effects/green_explosion.png")
var red = preload("res://assets/effects/red_explosion.png")
